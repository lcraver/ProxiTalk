...
![proxi-case](../wiki/imgs/build/case-parts.jpg)
...
![shell-prompt](../wiki/imgs/build/diet-pi-prompt.png)
...
![Raspberry Pi Zero pin diagram](../wiki/imgs/build/raspberry-pi-zero-pins.jpg)
...
![ProxiTalk power system](../wiki/imgs/build/power-system.jpg)
...
-   **USB-C Breakout Board** `GND` -> *both* **PowerBoost 1000C** `G` *and* **Raspberry Pi** `Ground` (there's several options, the picture uses `Pin 25`). I soldered a T-junction but do whatever works best for you!
   ...
   ![t-splice](../wiki/imgs/build/gnd-splice.jpg)
...
![Audio System](../wiki/imgs/build/audio-system.jpg)
...
![Bonnet Example](../wiki/imgs/build/pi-zero-bonnet-example.jpg)
...
![Bottom Assembly](../wiki/imgs/bottom-assembly.jpg)
...
![Middle Plate Wires](../wiki/imgs/build/middle-plate-application.jpg)

### Wiring the screen

![Screen Attachment](../wiki/imgs/build/screen-attachment.jpg)
...
![Screen Situated](../wiki/imgs/build/screen-situated.jpg)

### Wiring the keyboard

To wire the keyboard, you'll first need to get it out of that bulky case!

![Keyboard Disassembly](../wiki/imgs/build/keyboard-disassembly.jpg)
...
![Keyboard Components](../wiki/imgs/build/keyboard-components.jpg)
...
![Keyboard PCB situated](../wiki/imgs/build/keyboard-pcb-situated.jpg)
...
![Finished Assembly](../wiki/imgs/build/final-assembly.jpg)
