"""core_os's own text input buffer/autocomplete, independent of the old OS's
utils/text_input.py — uses core_os's own keymap.py and key_repeat.py."""

from __future__ import annotations

import bisect

from core_os.packages.input.key_repeat import KeyRepeat
from core_os.packages.input.keymap import key_map
